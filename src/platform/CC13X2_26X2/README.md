# Overview of CHIP CC13X2_26X2 Adaption

The following is an overview of the CC13X2_26X2 adaptation of CHIP. Most of this
code will have parallels in any new adaptation.

(All file names are relative to `connectedhomeip/src/platform/CC13X2_26X2...`).
...
`CC13X2_26X2Config.h` <br> `CC13X2_26X2Config.cpp`

- Concrete implementation of the Non-Volatile storage of information for chip

`CHIPDevicePlatformConfig.h`

- Configuration for the chip stack for the CC13X2_26X2 platform
