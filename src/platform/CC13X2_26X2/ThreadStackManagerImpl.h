...
// XXX: Seth generic openthread??
// XXX: Seth how to include openthread in the build?
...
// XXX: Seth where are these headers being pulled from?
// XXX: Seth the CPP file is not being pulled into the build for some reason
