...
// XXX: Seth update for TI configuration
...
// XXX: Seth, can we use this locking?
...
// XXX: Seth is there a platform specific error value to use??
#define CHIP_SYSTEM_CONFIG_ERROR_TYPE uint32_t
#define CHIP_SYSTEM_CONFIG_NO_ERROR (0)

// XXX: Seth need valuable numbers here
