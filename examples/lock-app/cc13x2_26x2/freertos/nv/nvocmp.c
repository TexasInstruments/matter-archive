...
#warning "=== DO NOT RELEASE === Code should be pushed back to common components"
#warning "=== DO NOT RELEASE === Do Not push to Github"
...
#define NVOCMP_UNLOCK() pthread_mutex_unlock(&NVOCMP_gPosixMutex);

#elif NVOCMP_FREERTOS_MUTEX
// Lock driver access via TI-RTOS gatemutex
#define NVOCMP_LOCK() xSemaphoreTakeRecursive(NVOCMP_gFreeRTOSMutex, 100);

// Unlock driver access via TI-RTOS gatemutex and return error code
#define NVOCMP_UNLOCK() xSemaphoreGiveRecursive(NVOCMP_gFreeRTOSMutex);
...
// Unlock driver access via TI-RTOS gatemutex and return error code
#define NVOCMP_UNLOCK() GateMutexPri_leave(NVOCMP_gMutexPri, key)
...
#elif NVOCMP_FREERTOS_MUTEX
static SemaphoreHandle_t NVOCMP_gFreeRTOSMutex;
#else
