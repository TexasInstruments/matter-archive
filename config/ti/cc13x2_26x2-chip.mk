...
#
#   @file
#         Component makefile for incorporating CHIP into and application based
#         on the Texas Instruments SDK
#
...
CHIP_CPPFLAGS = $(DEBUG_FLAGS) $(OPT_FLAGS) $(DEFINE_FLAGS) $(INC_FLAGS) 
CHIP_CXXFLAGS = $(STD_CXXFLAGS) $(CXXFLAGS) 
CHIP_CFLAGS = $(STD_CFLAGS) $(CFLAGS)
...
# Useless commet to reset my syntax highlighting, end quotes >>  "
...
# XXX: Seth changed the device layer and lwip target, what does that mean in the CHIP build?
# XXX: Seth what does the mbedTLS line mean? Do we link with a version of mbedtls?
...
# ==================================================
# Adjustments to standard build settings to incorporate CHIP
# ==================================================
...
STD_INC_DIRS += \
    ...
    $(CHIP_ROOT)/src/lwip/cc13x2_26x2

# Add the location of CHIP libraries to application link action.
STD_LDFLAGS += -L$(CHIP_OUTPUT_DIR)/lib

# XXX: Seth, this seems to be added in a group for repeat scanning, is there a better way to organize them?
...
# compilation targets to ensure that CHIP gets built and its header files
# installed prior to compiling any dependent source files.
...
# Add ChipBuildRules to the list of late-bound build rules that will be
